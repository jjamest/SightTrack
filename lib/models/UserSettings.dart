...
class UserSettings extends amplify_core.Model {
  ...
  bool? get randomPhotoOffset {
    return _randomPhotoOffset;
  }
  ...
  const UserSettings._internal(
      ...
      updatedAt})
      : _userId = userId,
        _randomPhotoOffset = randomPhotoOffset,
        _createdAt = createdAt,
        _updatedAt = updatedAt;

  factory UserSettings(
      {String? id, required String userId, bool? randomPhotoOffset}) {
  ...
  bool operator ==(Object other) {
    ...
    return other is UserSettings &&
        ...
        _randomPhotoOffset == other._randomPhotoOffset;
  }
  ...
  String toString() {
    ...
    buffer.write("randomPhotoOffset=" +
        (_randomPhotoOffset != null ? _randomPhotoOffset.toString() : "null") +
        ", ");
  ...
  UserSettings copyWith({String? userId, bool? randomPhotoOffset}) {
    return UserSettings._internal(
      id: id,
      userId: userId ?? this.userId,
      randomPhotoOffset: randomPhotoOffset ?? this.randomPhotoOffset,
    );
  }

  UserSettings copyWithModelFieldValues({
    ModelFieldValue<String>? userId,
    ModelFieldValue<bool?>? randomPhotoOffset,
  }) {
    return UserSettings._internal(
      id: id,
      userId: userId == null ? this.userId : userId.value,
      randomPhotoOffset: randomPhotoOffset == null
          ? this.randomPhotoOffset
          : randomPhotoOffset.value,
    );
  }
  ...
  UserSettings.fromJson(Map<String, dynamic> json)
      : id = json["id"],
        _userId = json["userId"],
        _randomPhotoOffset = json["randomPhotoOffset"],
  ...
  Map<String, dynamic> toJson() => {
        "id": id,
        "userId": _userId,
        "randomPhotoOffset": _randomPhotoOffset,
  ...
  static final RANDOMPHOTOOFFSET =
      amplify_core.QueryField(fieldName: "randomPhotoOffset");
  static var schema = amplify_core.Model.defineSchema(
    define: (amplify_core.ModelSchemaDefinition modelSchemaDefinition) {
      ...
      modelSchemaDefinition.addField(
        amplify_core.ModelFieldDefinition.field(
          key: UserSettings.RANDOMPHOTOOFFSET,
          isRequired: false,
          ofType:
