                ...
                child: _selectedImage == null &&
                    ...
                    : FutureBuilder<String>(
                        future: _selectedImage != null
                            ? Future.value(_selectedImage!
                                .path) // Use the selected file immediately
                            : ProfileScreen.loadProfilePicture(widget.user
                                .profilePicture!), // Get the URL if no file selected
